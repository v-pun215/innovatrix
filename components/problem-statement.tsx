        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-peach rounded-3xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg md:text-xl font-body text-purple-deep leading-relaxed mb-8">
              ...
              <p className="text-lg md:text-xl font-body text-purple-deep leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="bg-purple-light/20 rounded-2xl p-6 text-center">
              <div className="w-12 h-12 bg-purple-deep rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-white text-xl font-heading font-bold">1</span>
              </div>
              <h3 className="font-heading text-xl font-bold text-purple-deep mb-2">Lost Mission</h3>
              <p className="text-purple-deep/70 font-body text-sm">
            ...
            <div className="bg-gold/20 rounded-2xl p-6 text-center">
              <div className="w-12 h-12 bg-gold rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-white text-xl font-heading font-bold">2</span>
              </div>
              <h3 className="font-heading text-xl font-bold text-purple-deep mb-2">Visual Gap</h3>
              <p className="text-purple-deep/70 font-body text-sm">
            ...
            <div className="bg-blush rounded-2xl p-6 text-center">
              <div className="w-12 h-12 bg-purple-light rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-white text-xl font-heading font-bold">3</span>
              </div>
              <h3 className="font-heading text-xl font-bold text-purple-deep mb-2">Untapped Market</h3>
              <p className="text-purple-deep/70 font-body text-sm">
